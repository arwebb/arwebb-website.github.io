...
var question = 'I recently launched the Disaster Relief Toolkit, a project to help mutual aid organizers address on-the-ground needs when disasters impact their communities. I’m a NELI Ascending Leadership fellow for the 2021-22 cohort.<br><br>I use he, she, and they pronouns. I live in East Falls with my partner, her cat Fig, and my dog Saint.<br><br>For a summary of the information on this site, <a href="assets/arw-resume-2021.pdf" target="_blank">download my resume</a>.<br>For a good time, <a href="/game">try playing this website as a text-based game</a>.<br>For questions, or just to say hi, <a href="mailto:annierwebb@gmail.com" target="_blank">send me an email</a>.';
